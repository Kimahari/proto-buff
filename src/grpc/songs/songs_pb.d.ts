...
export class SongRequest extends jspb.Message { 
    getSongId(): number;
    setSongId(value: number): SongRequest;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SongRequest.AsObject;
    static toObject(includeInstance: boolean, msg: SongRequest): SongRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SongRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SongRequest;
    static deserializeBinaryFromReader(message: SongRequest, reader: jspb.BinaryReader): SongRequest;
}
