...
interface ISongsService_IGetSong extends grpc.MethodDefinition<songs_pb.SongRequest, songs_pb.Song> {
    path: "/songs.Songs/GetSong";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<songs_pb.SongRequest>;
    requestDeserialize: grpc.deserialize<songs_pb.SongRequest>;
...
export interface ISongsServer {
    getSong: grpc.handleUnaryCall<songs_pb.SongRequest, songs_pb.Song>;
...
export interface ISongsClient {
    getSong(request: songs_pb.SongRequest, callback: (error: grpc.ServiceError | null, response: songs_pb.Song) => void): grpc.ClientUnaryCall;
    getSong(request: songs_pb.SongRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: songs_pb.Song) => void): grpc.ClientUnaryCall;
    getSong(request: songs_pb.SongRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: songs_pb.Song) => void): grpc.ClientUnaryCall;
...
export class SongsClient extends grpc.Client implements ISongsClient {
    ...
    public getSong(request: songs_pb.SongRequest, callback: (error: grpc.ServiceError | null, response: songs_pb.Song) => void): grpc.ClientUnaryCall;
    public getSong(request: songs_pb.SongRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: songs_pb.Song) => void): grpc.ClientUnaryCall;
    public getSong(request: songs_pb.SongRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: songs_pb.Song) => void): grpc.ClientUnaryCall;
