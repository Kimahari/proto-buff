...
function serialize_songs_SongRequest(arg) {
  if (!(arg instanceof songs_pb.SongRequest)) {
    throw new Error('Expected argument of type songs.SongRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_songs_SongRequest(buffer_arg) {
  return songs_pb.SongRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SongsService = exports.SongsService = {
  getSong: {
    ...
    requestType: songs_pb.SongRequest,
    responseType: songs_pb.Song,
    requestSerialize: serialize_songs_SongRequest,
    requestDeserialize: deserialize_songs_SongRequest,
